...
function addArticle(){
    ...
    document.querySelector('#all_products').innerHTML =  document.querySelector('#all_products').innerHTML +  '<tr><td class="article--name"><div style="margin-right:1rem"><img src="images/Livre1.jfif"></div> <div><h3>'+ name.value +'<h3/> <a class="remove" id="1">Supprimer</a></div></td><td class="quantity"> <button class="qty-minus" id="1">-</button><input type="text" readonly placeholder="Unit price"  class="qty" value="1" ><button class="qty-plus" id="1">+</button></td><td class="price">' + price.value + '14$</td> <td class="subtotal">' + price.value + '14 $</td></tr>'
    loadNewElement();
