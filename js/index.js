...
function addProduct() {
    ...
    all_products.innerHTML =  all_products.innerHTML  + '<tr><td class="article--name"><div style="margin-right:1rem"><img src=""></div> <div><h3>' + name.value + '<h3/> <a class="remove" id="1">Supprimer</a></div></td><td class="quantity"> <button class="qty-minus" id="1">-</button><input type="text" readonly placeholder="Unit price"  class="qty" value="1" ><button class="qty-plus" id="1">+</button></td><td>' + price.value + '$</td> <td class="subtotal">' + price.value +' $</td></tr>'
    loadEvents()
